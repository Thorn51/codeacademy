...
def get_destination_index(destination):
    try:
        ...
        return "No Informatoin on Destination"
...
def add_attraction(destination, attraction):
    try:
        ...
        return "No information on location!"
...
def get_attractions_for_traveler(traveler):
    ...
    interests_string = f"Hi " + traveler[0] + ", we think you'll like thee places around " + traveler_destination +  ": "
